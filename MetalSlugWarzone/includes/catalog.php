...
function msw_map_catalog(): array {
    return [
        ...
        // The v2 roster enters through the eleven expansion warzones. Shared pools
        // drive player encounters, autonomous Commander recovery and force battles.
        'swamp_encampment'=>['name'=>'Swamp Encampment','region'=>'Deep Jungle','image'=>'assets/maps/swamp_encampment.png','thumbnail'=>'assets/maps/thumbnails/swamp_encampment.jpg','w'=>1672,'h'=>941,'level'=>13,'spawn'=>[835,775],'encounters'=>['rifle','bazooka','japanese_soldier','rebel_slug','rebel_helicopter']],
        'abandoned_carnival'=>['name'=>'Abandoned Carnival','region'=>'Occupied Fairgrounds','image'=>'assets/maps/abandoned_carnival.png','thumbnail'=>'assets/maps/thumbnails/abandoned_carnival.jpg','w'=>1672,'h'=>941,'level'=>14,'spawn'=>[875,725],'encounters'=>['rifle','biker','arab_soldier','rebel_gear','rebel_bomber']],
        'neon_district'=>['name'=>'Neon District','region'=>'Rainfall City','image'=>'assets/maps/neon_district.png','thumbnail'=>'assets/maps/thumbnails/neon_district.jpg','w'=>1672,'h'=>941,'level'=>15,'spawn'=>[835,725],'encounters'=>['biker','minigun','japanese_soldier','general_t','rebel_helicopter']],
        'scrapyard_depot'=>['name'=>'Scrapyard Depot','region'=>'Rebel Salvage Belt','image'=>'assets/maps/scrapyard_depot.png','thumbnail'=>'assets/maps/thumbnails/scrapyard_depot.jpg','w'=>1672,'h'=>941,'level'=>16,'spawn'=>[835,735],'encounters'=>['bazooka','biker','rebel_gear','rebel_slug','rebel_tank']],
        'canyon_missile_base'=>['name'=>'Canyon Missile Base','region'=>'Redstone Canyon','image'=>'assets/maps/canyon_missile_base.png','thumbnail'=>'assets/maps/thumbnails/canyon_missile_base.jpg','w'=>1672,'h'=>941,'level'=>17,'spawn'=>[835,780],'encounters'=>['bazooka','shield','arab_soldier','rebel_sam','rebel_tank']],
        'alpine_radar'=>['name'=>'Alpine Radar Station','region'=>'Mountain Command','image'=>'assets/maps/alpine_radar.png','thumbnail'=>'assets/maps/thumbnails/alpine_radar.jpg','w'=>1672,'h'=>941,'level'=>18,'spawn'=>[835,735],'encounters'=>['shield','bazooka','japanese_soldier','japanese_tank','japanese_hi_fighter','rebel_sam']],
        'offshore_platform'=>['name'=>'Offshore Platform','region'=>'Blackwater Supply Line','image'=>'assets/maps/offshore_platform.png','thumbnail'=>'assets/maps/thumbnails/offshore_platform.jpg','w'=>1672,'h'=>941,'level'=>19,'spawn'=>[835,695],'encounters'=>['minigun','shield','general_t','rebel_sam','rebel_helicopter','rebel_bomber']],
        'subterranean_terminus'=>['name'=>'Subterranean Terminus','region'=>'Underground Transit','image'=>'assets/maps/subterranean_terminus.png','thumbnail'=>'assets/maps/thumbnails/subterranean_terminus.jpg','w'=>1672,'h'=>941,'level'=>20,'spawn'=>[835,700],'encounters'=>['shield','biker','japanese_soldier','rebel_gear','japanese_tank','alien']],
        'volcanic_forge'=>['name'=>'Volcanic Forge','region'=>'Inferno Production Sector','image'=>'assets/maps/volcanic_forge.png','thumbnail'=>'assets/maps/thumbnails/volcanic_forge.jpg','w'=>1672,'h'=>941,'level'=>21,'spawn'=>[835,715],'encounters'=>['minigun','bazooka','general_t','rebel_slug','rebel_tank','alien_walker']],
        'containment_laboratory'=>['name'=>'Containment Laboratory','region'=>'Blacksite Research','image'=>'assets/maps/containment_laboratory.png','thumbnail'=>'assets/maps/thumbnails/containment_laboratory.jpg','w'=>1672,'h'=>941,'level'=>22,'spawn'=>[915,780],'encounters'=>['shield','minigun','alien','alien_walker','mini_ufo','general_t']],
        'lunar_outpost'=>['name'=>'Lunar Outpost','region'=>'Orbital Warzone','image'=>'assets/maps/lunar_outpost.png','thumbnail'=>'assets/maps/thumbnails/lunar_outpost.jpg','w'=>1672,'h'=>941,'level'=>23,'spawn'=>[980,780],'encounters'=>['bazooka','shield','alien','alien_walker','mini_ufo','japanese_hi_fighter']],
    ];
}
...
function msw_enemy_catalog(): array {
    return [
        ...
        // Preserve the established enemy keys and stats above. V2 recruits use the
        // existing personnel / ground vehicle / aircraft recovery classifications.
        'arab_soldier'=>['name'=>'Arab Soldier','class'=>'infantry','type'=>'melee','sprite'=>'assets/sprites/enemies/arab_soldier.png','hp'=>64,'atk'=>19,'def'=>12,'spd'=>17,'recruitable'=>1],
        'japanese_soldier'=>['name'=>'Japanese Soldier','class'=>'infantry','type'=>'melee','sprite'=>'assets/sprites/enemies/japanese_soldier.png','hp'=>70,'atk'=>20,'def'=>14,'spd'=>13,'recruitable'=>1],
        'general_t'=>['name'=>'General T','class'=>'heavy_infantry','type'=>'explosive','sprite'=>'assets/sprites/enemies/general_t.png','hp'=>88,'atk'=>27,'def'=>18,'spd'=>10,'recruitable'=>1],
        'alien'=>['name'=>'Alien','class'=>'infantry','type'=>'energy','sprite'=>'assets/sprites/enemies/alien.png','hp'=>66,'atk'=>21,'def'=>11,'spd'=>16,'recruitable'=>1],
        'rebel_gear'=>['name'=>'Rebel Gear','class'=>'vehicle','type'=>'heavy','sprite'=>'assets/sprites/enemies/rebel_gear.png','hp'=>102,'atk'=>26,'def'=>24,'spd'=>11,'recruitable'=>1],
        'rebel_slug'=>['name'=>'Rebel Slug','class'=>'vehicle','type'=>'explosive','sprite'=>'assets/sprites/enemies/rebel_slug.png','hp'=>118,'atk'=>28,'def'=>27,'spd'=>12,'recruitable'=>1],
        'rebel_tank'=>['name'=>'Rebel Tank','class'=>'vehicle','type'=>'explosive','sprite'=>'assets/sprites/enemies/rebel_tank.png','hp'=>142,'atk'=>31,'def'=>32,'spd'=>6,'recruitable'=>1],
        'rebel_sam'=>['name'=>'Rebel S.A.M.','class'=>'vehicle','type'=>'anti_armor','sprite'=>'assets/sprites/enemies/rebel_sam.png','hp'=>112,'atk'=>30,'def'=>22,'spd'=>7,'recruitable'=>1],
        'japanese_tank'=>['name'=>'Japanese Tank','class'=>'vehicle','type'=>'explosive','sprite'=>'assets/sprites/enemies/japanese_tank.png','hp'=>128,'atk'=>29,'def'=>30,'spd'=>6,'recruitable'=>1],
        'alien_walker'=>['name'=>'Alien Walker','class'=>'vehicle','type'=>'energy','sprite'=>'assets/sprites/enemies/alien_walker.png','hp'=>116,'atk'=>27,'def'=>25,'spd'=>9,'recruitable'=>1],
        'rebel_helicopter'=>['name'=>'Rebel Helicopter','class'=>'air','type'=>'heavy','sprite'=>'assets/sprites/enemies/rebel_helicopter.png','hp'=>110,'atk'=>28,'def'=>20,'spd'=>22,'recruitable'=>1],
        'rebel_bomber'=>['name'=>'Rebel Bomber','class'=>'air','type'=>'explosive','sprite'=>'assets/sprites/enemies/rebel_bomber.png','hp'=>108,'atk'=>29,'def'=>17,'spd'=>12,'recruitable'=>1],
        'japanese_hi_fighter'=>['name'=>'Japanese Hi Fighter','class'=>'air','type'=>'heavy','sprite'=>'assets/sprites/enemies/japanese_hi_fighter.png','hp'=>96,'atk'=>26,'def'=>18,'spd'=>25,'recruitable'=>1],
        'mini_ufo'=>['name'=>'Mini-UFO','class'=>'air','type'=>'energy','sprite'=>'assets/sprites/enemies/mini_ufo.png','hp'=>72,'atk'=>23,'def'=>12,'spd'=>23,'recruitable'=>1],
        'hi_do'=>['name'=>'Hi-Do','class'=>'boss','type'=>'explosive','sprite'=>'assets/sprites/enemies/hi_do.png','hp'=>620,'atk'=>50,'def'=>40,'spd'=>18,'recruitable'=>0],
        'ufo_boss'=>['name'=>'UFO Boss','class'=>'boss','type'=>'energy','sprite'=>'assets/sprites/enemies/ufo_boss.png','hp'=>700,'atk'=>54,'def'=>42,'spd'=>16,'recruitable'=>0],
    ];
}
...
function msw_mission_catalog(): array {
    return [
        ...
        // Additional v2 target operations. Legacy missions above keep their keys, order and rewards.
        'reedline_duel'=>['name'=>'Reedline Duel','brief'=>'Engage the Japanese Soldier guarding the swamp footbridge and secure the patrol supply cache.','enemy'=>'japanese_soldier','level'=>13,'commander_xp'=>260,'reward'=>['common_metal'=>650,'fuel'=>380,'biological'=>160,'gmp'=>2600],'map_key'=>'swamp_encampment'],
        'swamp_slug_intercept'=>['name'=>'Swamp Slug Intercept','brief'=>'Intercept the Rebel Slug moving through the encampment channels and break its hold on the marsh supply route.','enemy'=>'rebel_slug','level'=>13,'commander_xp'=>280,'reward'=>['common_metal'=>720,'minor_metal'=>260,'fuel'=>450,'gmp'=>2900],'map_key'=>'swamp_encampment'],
        'midway_blade_hunt'=>['name'=>'Midway Blade Hunt','brief'=>'Challenge the Arab Soldier patrolling the abandoned midway and recover the stores hidden beneath the fairground stalls.','enemy'=>'arab_soldier','level'=>14,'commander_xp'=>300,'reward'=>['common_metal'=>740,'minor_metal'=>360,'fuel'=>420,'gmp'=>2900],'map_key'=>'abandoned_carnival'],
        'neon_rotor_sweep'=>['name'=>'Neon Rotor Sweep','brief'=>'Engage the Rebel Helicopter sweeping the neon crossroads and reopen the district supply corridor.','enemy'=>'rebel_helicopter','level'=>15,'commander_xp'=>360,'reward'=>['minor_metal'=>520,'precious_metal'=>140,'fuel'=>620,'gmp'=>3500],'map_key'=>'neon_district'],
        'scrapwalker_shutdown'=>['name'=>'Scrapwalker Shutdown','brief'=>'Stop the Rebel Gear guarding the salvage conveyors and secure the depot stockpile before it is moved.','enemy'=>'rebel_gear','level'=>16,'commander_xp'=>400,'reward'=>['common_metal'=>1050,'minor_metal'=>550,'precious_metal'=>155,'gmp'=>3900],'map_key'=>'scrapyard_depot'],
        'canyon_sam_silence'=>['name'=>'Canyon S.A.M. Silence','brief'=>'Neutralize the Rebel S.A.M. covering the canyon launch pads and claim its missile support stores.','enemy'=>'rebel_sam','level'=>17,'commander_xp'=>440,'reward'=>['minor_metal'=>620,'precious_metal'=>180,'fuel'=>740,'gmp'=>4300],'map_key'=>'canyon_missile_base'],
        'alpine_fighter_intercept'=>['name'=>'Alpine Fighter Intercept','brief'=>'Intercept the Japanese Hi Fighter protecting the mountain radar approach and seize the air patrol reserve equipment.','enemy'=>'japanese_hi_fighter','level'=>18,'commander_xp'=>480,'reward'=>['common_metal'=>1100,'minor_metal'=>650,'fuel'=>850,'gmp'=>4700],'map_key'=>'alpine_radar'],
        'blackwater_bomber_run'=>['name'=>'Blackwater Bomber Run','brief'=>'Engage the Rebel Bomber threatening the offshore loading deck and secure the platform fuel shipment.','enemy'=>'rebel_bomber','level'=>19,'commander_xp'=>520,'reward'=>['common_metal'=>1300,'minor_metal'=>700,'fuel'=>1000,'gmp'=>5300],'map_key'=>'offshore_platform'],
        'terminus_tank_blockade'=>['name'=>'Terminus Tank Blockade','brief'=>'Break the Japanese Tank blockade inside the underground terminus and recover the trapped freight cargo.','enemy'=>'japanese_tank','level'=>20,'commander_xp'=>560,'reward'=>['common_metal'=>1450,'minor_metal'=>800,'precious_metal'=>240,'gmp'=>5900],'map_key'=>'subterranean_terminus'],
        'forge_armor_breaker'=>['name'=>'Forge Armour Breaker','brief'=>'Engage the Rebel Tank defending the furnace access road and seize the refined armour shipment.','enemy'=>'rebel_tank','level'=>21,'commander_xp'=>600,'reward'=>['common_metal'=>1620,'minor_metal'=>900,'precious_metal'=>280,'gmp'=>6600],'map_key'=>'volcanic_forge'],
        'blacksite_command_break'=>['name'=>'Blacksite Command Break','brief'=>'Confront General T at the containment security checkpoint and recover the command staff research stores.','enemy'=>'general_t','level'=>22,'commander_xp'=>640,'reward'=>['minor_metal'=>880,'precious_metal'=>300,'biological'=>700,'gmp'=>6900],'map_key'=>'containment_laboratory'],
        'lunar_alien_contact'=>['name'=>'Lunar Alien Contact','brief'=>'Engage the Alien sentry at the lunar base research perimeter and secure its extraterrestrial supply cache.','enemy'=>'alien','level'=>23,'commander_xp'=>680,'reward'=>['minor_metal'=>960,'precious_metal'=>340,'biological'=>1050,'gmp'=>7600],'map_key'=>'lunar_outpost'],
        'lunar_walker_siege'=>['name'=>'Lunar Walker Siege','brief'=>'Stop the Alien Walker advancing through the lunar base cargo yard and recover its technical reserve stores.','enemy'=>'alien_walker','level'=>23,'commander_xp'=>720,'reward'=>['common_metal'=>1950,'minor_metal'=>1050,'precious_metal'=>360,'gmp'=>8100],'map_key'=>'lunar_outpost'],
        'lunar_scout_intercept'=>['name'=>'Lunar Scout Intercept','brief'=>'Intercept the Mini-UFO scanning the lunar base landing zone and secure the orbital equipment it is guarding.','enemy'=>'mini_ufo','level'=>23,'commander_xp'=>700,'reward'=>['minor_metal'=>1000,'precious_metal'=>360,'fuel'=>1150,'gmp'=>7900],'map_key'=>'lunar_outpost'],
        'blackwater_hi_do_strike'=>['name'=>'Blackwater Hi-Do Strike','brief'=>'Bring down the Hi-Do command gunship above the offshore platform and secure its high-value support cargo. This boss cannot be captured.','enemy'=>'hi_do','level'=>19,'commander_xp'=>720,'reward'=>['common_metal'=>1850,'precious_metal'=>280,'fuel'=>1500,'gmp'=>8500],'map_key'=>'offshore_platform'],
        'lunar_ufo_assault'=>['name'=>'Lunar UFO Assault','brief'=>'Destroy the UFO Boss directing the assault on the lunar base and seize the command vessel reserve materials. This boss cannot be captured.','enemy'=>'ufo_boss','level'=>23,'commander_xp'=>880,'reward'=>['minor_metal'=>1550,'precious_metal'=>520,'biological'=>1200,'gmp'=>11000],'map_key'=>'lunar_outpost'],
    ];
}
function msw_boss_catalog(): array {
    return [
        ...
        'hi_do'=>['name'=>'Hi-Do','enemy'=>'hi_do','threat'=>'S++','level'=>19,'brief'=>'Rebel aerial command gunship sighted above the Blackwater supply line. Break its heavy bombardment and bring down the flagship.','map_key'=>'offshore_platform'],
        'ufo_boss'=>['name'=>'UFO Boss','enemy'=>'ufo_boss','threat'=>'S++','level'=>23,'brief'=>'An extraterrestrial command vessel is directing the lunar occupation. Defeat its energy barrage to end the orbital assault.','map_key'=>'lunar_outpost'],
    ];
}
function msw_dispatch_catalog(): array {
    return [
        ...
        // Authored v2 opposition: first entry is the named target, followed by its escort.
        // Replay presentation consumes this list; the shared dispatch ledger owns outcomes.
        'reedline_patrol_break'=>['name'=>'Reedline Patrol Break','brief'=>'Send staff to defeat the Japanese Soldier patrol at the swamp footbridge and escort its field supplies back to base.','level'=>13,'duration'=>9300,'difficulty'=>440,'slots'=>4,'staff_xp_success'=>130,'staff_xp_failure'=>35,'reward'=>['gmp'=>4900,'common_metal'=>550,'fuel'=>270,'biological'=>190],'map_key'=>'swamp_encampment','recommended_staff_level'=>20,'enemies'=>['japanese_soldier','rifle','bazooka','rebel_slug']],
        'marsh_slug_supply_raid'=>['name'=>'Marsh Slug Supply Raid','brief'=>'Deploy a squad against the Rebel Slug escorting a marsh convoy and bring back the vehicle maintenance shipment.','level'=>13,'duration'=>9600,'difficulty'=>480,'slots'=>4,'staff_xp_success'=>150,'staff_xp_failure'=>40,'reward'=>['gmp'=>5500,'common_metal'=>650,'minor_metal'=>320,'fuel'=>340],'map_key'=>'swamp_encampment','recommended_staff_level'=>20,'enemies'=>['rebel_slug','japanese_soldier','rifle','bazooka']],
        'midway_swordsman_sweep'=>['name'=>'Midway Swordsman Sweep','brief'=>'Hunt the Arab Soldier guarding the shuttered carnival stalls and recover the supplies under the patrol watch.','level'=>14,'duration'=>11100,'difficulty'=>500,'slots'=>4,'staff_xp_success'=>160,'staff_xp_failure'=>40,'reward'=>['gmp'=>6000,'common_metal'=>680,'minor_metal'=>360,'fuel'=>310],'map_key'=>'abandoned_carnival','recommended_staff_level'=>25,'enemies'=>['arab_soldier','rifle','biker','rebel_gear']],
        'neon_air_corridor'=>['name'=>'Neon Air Corridor','brief'=>'Send a covered recovery squad to challenge the Rebel Helicopter patrol and extract technical cargo from the rain-soaked crossroads.','level'=>15,'duration'=>13200,'difficulty'=>590,'slots'=>4,'staff_xp_success'=>200,'staff_xp_failure'=>50,'reward'=>['gmp'=>7700,'minor_metal'=>520,'precious_metal'=>145,'fuel'=>520],'map_key'=>'neon_district','recommended_staff_level'=>30,'enemies'=>['rebel_helicopter','general_t','japanese_soldier','minigun']],
        'scrap_gear_interdiction'=>['name'=>'Scrap Gear Interdiction','brief'=>'Defeat the Rebel Gear guarding the salvage conveyors and escort usable machinery out of the depot.','level'=>16,'duration'=>15000,'difficulty'=>660,'slots'=>4,'staff_xp_success'=>240,'staff_xp_failure'=>55,'reward'=>['gmp'=>9000,'common_metal'=>1050,'minor_metal'=>620,'precious_metal'=>170],'map_key'=>'scrapyard_depot','recommended_staff_level'=>35,'enemies'=>['rebel_gear','rebel_slug','bazooka','biker']],
        'canyon_missile_screen'=>['name'=>'Canyon Missile Screen','brief'=>'Dispatch staff to break the Rebel S.A.M. missile screen and recover the launch line support shipment.','level'=>17,'duration'=>16800,'difficulty'=>720,'slots'=>4,'staff_xp_success'=>270,'staff_xp_failure'=>60,'reward'=>['gmp'=>10400,'minor_metal'=>740,'precious_metal'=>210,'fuel'=>760],'map_key'=>'canyon_missile_base','recommended_staff_level'=>40,'enemies'=>['rebel_sam','arab_soldier','bazooka','shield']],
        'alpine_air_patrol_hunt'=>['name'=>'Alpine Air Patrol Hunt','brief'=>'Intercept the Japanese Hi Fighter patrol with a veteran squad and secure technical cargo below the radar installation.','level'=>18,'duration'=>18600,'difficulty'=>770,'slots'=>4,'staff_xp_success'=>290,'staff_xp_failure'=>65,'reward'=>['gmp'=>11600,'common_metal'=>1250,'minor_metal'=>780,'fuel'=>800],'map_key'=>'alpine_radar','recommended_staff_level'=>45,'enemies'=>['japanese_hi_fighter','japanese_soldier','japanese_tank','bazooka']],
        'blackwater_bomber_screen'=>['name'=>'Blackwater Bomber Screen','brief'=>'Send staff to defeat the Rebel Bomber covering an offshore shipment and escort the recovered fuel to the extraction deck.','level'=>19,'duration'=>20400,'difficulty'=>830,'slots'=>4,'staff_xp_success'=>320,'staff_xp_failure'=>70,'reward'=>['gmp'=>13200,'common_metal'=>1450,'minor_metal'=>850,'fuel'=>1100],'map_key'=>'offshore_platform','recommended_staff_level'=>50,'enemies'=>['rebel_bomber','rebel_helicopter','general_t','minigun']],
        'tunnel_tank_interdiction'=>['name'=>'Tunnel Tank Interdiction','brief'=>'Break the Japanese Tank escort inside the underground terminus and recover the freight convoy construction cargo.','level'=>20,'duration'=>22200,'difficulty'=>900,'slots'=>4,'staff_xp_success'=>360,'staff_xp_failure'=>75,'reward'=>['gmp'=>14900,'common_metal'=>1650,'minor_metal'=>950,'precious_metal'=>300],'map_key'=>'subterranean_terminus','recommended_staff_level'=>55,'enemies'=>['japanese_tank','japanese_soldier','rebel_gear','shield']],
        'forge_tank_stockpile'=>['name'=>'Forge Tank Stockpile Raid','brief'=>'Deploy an armoured recovery squad against the Rebel Tank defending the forge stockpile and retrieve refined metal.','level'=>21,'duration'=>24000,'difficulty'=>960,'slots'=>4,'staff_xp_success'=>390,'staff_xp_failure'=>80,'reward'=>['gmp'=>16400,'common_metal'=>1850,'minor_metal'=>1080,'precious_metal'=>330],'map_key'=>'volcanic_forge','recommended_staff_level'=>60,'enemies'=>['rebel_tank','rebel_slug','general_t','minigun']],
        'blacksite_general_raid'=>['name'=>'Blacksite General Raid','brief'=>'Send specialist staff to defeat General T and the containment security detail, then recover the blacksite research shipment.','level'=>22,'duration'=>25800,'difficulty'=>1000,'slots'=>4,'staff_xp_success'=>410,'staff_xp_failure'=>85,'reward'=>['gmp'=>17600,'minor_metal'=>1150,'precious_metal'=>370,'biological'=>900],'map_key'=>'containment_laboratory','recommended_staff_level'=>65,'enemies'=>['general_t','shield','minigun','alien']],
        'lunar_alien_cache_raid'=>['name'=>'Lunar Alien Cache Raid','brief'=>'Deploy an elite squad against the Alien sentry force at the lunar base and return with extraterrestrial research materials.','level'=>23,'duration'=>27300,'difficulty'=>1040,'slots'=>4,'staff_xp_success'=>430,'staff_xp_failure'=>85,'reward'=>['gmp'=>19100,'minor_metal'=>1280,'precious_metal'=>400,'biological'=>1100],'map_key'=>'lunar_outpost','recommended_staff_level'=>70,'enemies'=>['alien','mini_ufo','alien_walker','shield']],
        'lunar_walker_salvage'=>['name'=>'Lunar Walker Salvage','brief'=>'Defeat the Alien Walker holding the lunar base cargo yard and escort recovered machinery through the orbital perimeter.','level'=>23,'duration'=>27600,'difficulty'=>1080,'slots'=>4,'staff_xp_success'=>450,'staff_xp_failure'=>90,'reward'=>['gmp'=>20200,'common_metal'=>2050,'minor_metal'=>1380,'precious_metal'=>430],'map_key'=>'lunar_outpost','recommended_staff_level'=>70,'enemies'=>['alien_walker','alien','mini_ufo','bazooka']],
        'lunar_ufo_scout_sweep'=>['name'=>'Lunar UFO Scout Sweep','brief'=>'Send staff to intercept the Mini-UFO reconnaissance patrol and recover the lunar base landing zone equipment.','level'=>23,'duration'=>27600,'difficulty'=>1070,'slots'=>4,'staff_xp_success'=>440,'staff_xp_failure'=>90,'reward'=>['gmp'=>19800,'minor_metal'=>1320,'precious_metal'=>420,'fuel'=>1450],'map_key'=>'lunar_outpost','recommended_staff_level'=>70,'enemies'=>['mini_ufo','alien','alien_walker','shield']],
        'blackwater_flagship_raid'=>['name'=>'Blackwater Flagship Raid','brief'=>'Commit an elite staff squad against Hi-Do and its aerial escort. Destroy the boss gunship and recover its offshore support shipment.','level'=>19,'duration'=>23400,'difficulty'=>1020,'slots'=>4,'staff_xp_success'=>420,'staff_xp_failure'=>85,'reward'=>['gmp'=>17000,'common_metal'=>1850,'minor_metal'=>1150,'fuel'=>1550],'map_key'=>'offshore_platform','recommended_staff_level'=>50,'enemies'=>['hi_do','rebel_helicopter','rebel_bomber','rebel_sam']],
        'lunar_command_ship_raid'=>['name'=>'Lunar Command Ship Raid','brief'=>'Deploy the best staff squad against the UFO Boss and its alien escorts above the lunar base. Destroy the command vessel and secure its reserve cargo.','level'=>23,'duration'=>30600,'difficulty'=>1340,'slots'=>4,'staff_xp_success'=>540,'staff_xp_failure'=>105,'reward'=>['gmp'=>25000,'minor_metal'=>1750,'precious_metal'=>560,'biological'=>1250,'fuel'=>1450],'map_key'=>'lunar_outpost','recommended_staff_level'=>70,'enemies'=>['ufo_boss','mini_ufo','alien_walker','alien']],
    ];
}
