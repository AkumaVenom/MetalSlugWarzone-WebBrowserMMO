...
function msw_footer(): void { ?><footer class="footer"><span>METAL SLUG WARZONE // YOUR WARZONE, ALWAYS READY</span><span>v<?=msw_e((string)msw_config()['version'])?></span></footer></main><script src="<?=msw_e(msw_url('assets/js/msw.js?v='.rawurlencode((string)msw_config()['version'])))?>"></script></body></html><?php }
