...
function msw_console_page_label(string $route): string {
    static $labels = [
        ...
        'rd.php'=>'R&D Laboratory', 'dispatch.php'=>'Combat Dispatch', 'dispatch_result.php'=>'Dispatch Battle Playback', 'strategic.php'=>'Strategic Systems',
        ...
        'fob_dispatch.php'=>'FOB Staff Strike Ledger', 'fob_dispatch_result.php'=>'FOB Strike Battle Playback', 'fob_attack.php'=>'FOB Raid Action', 'fob_result.php'=>'FOB Raid Battle Report', 'pvp.php'=>'PvP Network',
