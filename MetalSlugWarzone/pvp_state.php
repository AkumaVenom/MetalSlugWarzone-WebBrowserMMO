...
$allowed=msw_one('SELECT id FROM pvp_matches WHERE id=? AND (player1_id=? OR player2_id=?)','iii',[$id,$uid,$uid]);if(!$allowed){http_response_code(404);echo json_encode(['error'=>'PvP battle not found']);exit;}
