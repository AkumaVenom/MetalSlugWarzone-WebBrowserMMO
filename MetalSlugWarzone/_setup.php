...
<section class="panel"><div class="panel-body"><h3>Update / Repair</h3><p>Safely updates an existing installation. Missing database pieces are added without wiping player progress.</p><form method="post"><input type="hidden" name="csrf" value="<?=htmlspecialchars($csrf,ENT_QUOTES,'UTF-8')?>"><button name="action" value="repair">Update / Repair</button></form></div></section>
