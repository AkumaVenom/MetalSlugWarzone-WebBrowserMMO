...
?>
<section class="hero"><div class="eyebrow">PERSONNEL MANAGEMENT · SECURITY TEAM LV <?=intval($securityLevel)?></div><h1>STAFF <span>ROSTER</span></h1><p>Recovered soldiers and hardware stay in your roster. Assign personnel to Security, then choose up to two soldiers as battle backup. They automatically provide light covering fire while your Commander remains the main fighter.</p></section>

<section class="panel security-party-panel" style="margin-top:18px"><div class="panel-head"><div><small>SECURITY ESCORT DETAIL · <?=intval($backupCapacity)?> SLOTS</small><h2>Security Backup Squad</h2></div><span class="bolts">•••</span></div><div class="panel-body"><p class="muted-copy">Security Lv 1 unlocks two backup slots. Lv 4 improves backup accuracy, and Lv 7 slightly increases support damage. Staff on dispatch missions automatically sit out until they return.</p>
